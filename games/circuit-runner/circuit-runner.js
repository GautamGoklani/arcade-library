...
(function (global) {
  ...
  function createSound() {
    ...
    return {
      ...
      // Charges rise a step at a time, so a clean run up the board sounds like
      // one. It resets whenever the meter is nearly full, which is exactly
      // when a charge has stopped mattering.
