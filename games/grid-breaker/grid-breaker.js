...
(function (global) {
  ...
  var WASM_B64 = "";
  ...
  function mount(container, opts) {
    ...
    function loop(now) {
      ...
      if (running) {
        ...
        // ---- events, derived by diffing this frame against the last ----
        var r, c, idx, hp, kind;
        for (r = 0; r < ROWS; r++) {
          for (c = 0; c < COLS; c++) {
            idx = r * COLS + c;
            hp = f32[(TILES_OFF + idx * TILE_STRIDE) / 4];
            kind = f32[(TILES_OFF + idx * TILE_STRIDE) / 4 + 1];
            if (prevTileHp[idx] > 0 && hp <= 0) {
              var cx = GRID_X + c * TILE_W + TILE_W / 2;
              var cy = GRID_Y + r * TILE_H + TILE_H / 2;
              var pal = tilePalette(kind, 1) || ROW_COLORS[r % ROW_COLORS.length];
              if (kind === 2) {
                burst(cx, cy, '#ff7a1e', 22, 260);
                shake = Math.max(shake, 7);
                sound.bomb();
              } else {
                burst(cx, cy, pal[0], 8, 150);
                sound.brick(r);
              }
            } else if (prevTileHp[idx] > hp && hp > 0) {
              sound.tough();
            }
            prevTileHp[idx] = hp;
          }
        ...
        if (lvl !== lastLevel) {
          lastLevel = lvl;
          showBanner('LEVEL ' + lvl);
          sound.level();
          snapshotTiles();
        }

        var lives = wasm.exports.get_lives();
        if (lives < prevLives) {
          flash = 0.3;
      ...
      if (ballsAlive < prevBallCount && running) sound.wall();
      prevBallCount = ballsAlive;
